      ...
      <div className="lg:px-2.5">
        ...
        <div className="relative group mb-0.5">
          ...
          <button
            ...
            className={`hidden absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 z-30 scale-0 transition-all ease-ease duration-300 rounded-full bg-red-700 h-11 w-11 lg:inline-flex lg:items-center lg:justify-center shadow-xl shadow-black/10 ${isHoverProductCard ? "scale-100" : ""
              } group1`}
          >
        ...
        <div className="px-4 relative pb-3 min-h-[120px]">
          ...
          <div
            ...
            className={`flex items-center justify-center h-0 ${isHoverProductCard ? "h-[92px]" : ""
              }`}
          >
            <button
              className={`flex items-center space-x-1 bg-red-700 rounded-3xl h-[30px] cursor-pointer text-[13px] px-5 text-white opacity-0 text-center transition-all ease-ease duration-300 ${isHoverProductCard ? "opacity-100" : ""
                }`}
            >
